...
public class ViewChaptersDao {
	...
	//Á¬½ÓÊý¾Ý¿â
		...
		//¶·ÆÆ
		public List<ViewChapters> getAllViewDoupo(){
			PreparedStatement ps = null;
			ResultSet rs = null;
			List<ViewChapters> list = new ArrayList<ViewChapters>();
			try {
				ps = getConntion().prepareStatement("select * from ¶·ÆÆ²Ôñ·");
				rs = ps.executeQuery();
				while(rs.next()){
					ViewChapters vc = new ViewChapters();
					vc.setText_Id(rs.getInt("text_id"));
		...
		//¶·ÂÞ
				public List<ViewChapters> getAllViewDouluo(){
					PreparedStatement ps = null;
					ResultSet rs = null;
					List<ViewChapters> list = new ArrayList<ViewChapters>();
					try {
						ps = getConntion().prepareStatement("select * from xdouluo");
						rs = ps.executeQuery();
						while(rs.next()){
							ViewChapters vc = new ViewChapters();
							vc.setText_Id(rs.getInt("text_id"));
				...
				//ÉñÄ¹
				public List<ViewChapters> getAllViewShenmu(){
					PreparedStatement ps = null;
					ResultSet rs = null;
					List<ViewChapters> list = new ArrayList<ViewChapters>();
					try {
						ps = getConntion().prepareStatement("select * from xshenmu");
						rs = ps.executeQuery();
						while(rs.next()){
							ViewChapters vc = new ViewChapters();
							vc.setText_Id(rs.getInt("text_id"));
				...
				//ÕÚÌì
				public List<ViewChapters> getAllViewZhetian(){
					PreparedStatement ps = null;
					ResultSet rs = null;
					List<ViewChapters> list = new ArrayList<ViewChapters>();
					try {
						ps = getConntion().prepareStatement("select * from xzhetian");
						rs = ps.executeQuery();
						while(rs.next()){
							ViewChapters vc = new ViewChapters();
							vc.setText_Id(rs.getInt("text_id"));
